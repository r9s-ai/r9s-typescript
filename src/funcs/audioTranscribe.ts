...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(models.AudioTranscriptionRequest$outboundSchema, value),
  ...
  const headers = new Headers(compactMap({
    Accept:
      "application/json;q=1, text/plain;q=0.8, application/x-subrip;q=0.5, text/vtt;q=0",
  }));
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.CreateAudioTranscriptionResponse$inboundSchema),
    M.text(200, models.CreateAudioTranscriptionResponse$inboundSchema),
    M.text(200, models.CreateAudioTranscriptionResponse$inboundSchema, {
