 ...
 */
export function audioTranslate(
  client: R9SCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(models.AudioTranslationRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.CreateAudioTranslationResponse$inboundSchema),
    M.text(200, models.CreateAudioTranslationResponse$inboundSchema),
