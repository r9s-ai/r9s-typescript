...
export function messagesCreate(
  client: R9SCore,
  request: models.AnthropicMessageRequest & { stream?: false },
...
export function messagesCreate(
  ...
  Result<
    EventStream<models.AnthropicStreamEvent>,
    | errors.BadRequestError
    | errors.AuthenticationError
    | errors.PermissionDeniedError
    | errors.ConflictError
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(models.AnthropicMessageRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.CreateMessageResponse$inboundSchema),
    M.sse(200, models.CreateMessageResponse$inboundSchema),
