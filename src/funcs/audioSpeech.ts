...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(models.AudioSpeechRequest$outboundSchema, value),
  ...
  const headers = new Headers(compactMap({
    ...
    Accept:
      "audio/aac;q=1, audio/flac;q=0.8, audio/mpeg;q=0.7, audio/opus;q=0.5, audio/pcm;q=0.3, audio/wav;q=0",
  }));
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.stream(200, models.CreateAudioSpeechResponse$inboundSchema, {
      ctype: "audio/mpeg",
    }),
    M.stream(200, models.CreateAudioSpeechResponse$inboundSchema, {
      ctype: "audio/opus",
