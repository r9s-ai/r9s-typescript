...
export function completionsCreate(
  client: R9SCore,
  request: models.CompletionRequest & { stream?: false },
...
export function completionsCreate(
  ...
  Result<
    EventStream<models.CompletionStreamEvent>,
    | errors.BadRequestError
    | errors.AuthenticationError
    | errors.PermissionDeniedError
    | errors.UnprocessableEntityError
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(models.CompletionRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.CreateCompletionResponse$inboundSchema),
    M.sse(200, models.CreateCompletionResponse$inboundSchema),
