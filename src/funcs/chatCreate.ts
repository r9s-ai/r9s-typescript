...
export function chatCreate(
  client: R9SCore,
  request: models.ChatCompletionRequest & { stream?: false },
...
export function chatCreate(
  ...
  Result<
    EventStream<models.ChatCompletionStreamEvent>,
    | errors.BadRequestError
    | errors.AuthenticationError
    | errors.PermissionDeniedError
    | errors.ConflictError
...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.CreateChatCompletionResponse$inboundSchema),
    M.sse(200, models.CreateChatCompletionResponse$inboundSchema),
