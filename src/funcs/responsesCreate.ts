...
export function responsesCreate(
  client: R9SCore,
  request: models.ResponseRequest & { stream?: false },
...
export function responsesCreate(
  ...
  Result<
    EventStream<models.ResponseStreamEvent>,
    | errors.BadRequestError
    | errors.AuthenticationError
    | errors.PermissionDeniedError
    | errors.ConflictError
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(models.ResponseRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.CreateResponseResponse$inboundSchema),
    M.sse(200, models.CreateResponseResponse$inboundSchema),
